...
local potions = {
	...
	[7588] = {health = {250, 350}, vocations = {3, 4, 7, 8}, level = 50, flask = 0,
			description = "Only knights and paladins of level 50 or above may drink this fluid."},

	[7589] = {mana = {115, 185}, vocations = {1, 2, 3, 5, 6, 7}, level = 50, flask = 0,
			description = "Only sorcerers, druids and paladins of level 50 or above may drink this fluid."},

	[7590] = {mana = {150, 250}, vocations = {1, 2, 5, 6}, level = 80, flask = 0,
			description = "Only druids and sorcerers of level 80 or above may drink this fluid."},

	[7591] = {health = {425, 575}, vocations = {4, 8}, level = 80, flask = 0,
			description = "Only knights of level 80 or above may drink this fluid."},

	[7618] = {health = {125, 175}, flask = 0},
	[7620] = {mana = {75, 125}, flask = 0},
	[8472] = {health = {250, 350}, mana = {100, 200}, vocations = {3, 7}, level = 80, flask = 0,
			description = "Only paladins of level 80 or above may drink this fluid."},

	[8473] = {health = {650, 850}, vocations = {4, 8}, level = 130, flask = 0,
			description = "Only knights of level 130 or above may drink this fluid."},

	[8474] = {combat = antidote, flask = 0},
	[8704] = {health = {60, 90}, flask = 0},
	[26029] = {mana = {425, 575}, vocations = {1, 2, 5, 6}, level = 130, flask = 0,
			description = "Only druids and sorcerers of level 130 or above may drink this fluid."},

	[26030] = {health = {420, 580}, mana = {250, 350}, vocations = {3, 7}, level = 130, flask = 0,
			description = "Only paladins of level 130 or above may drink this fluid."},

	[26031] = {health = {875, 1125}, vocations = {4, 8}, level = 200, flask = 0,
